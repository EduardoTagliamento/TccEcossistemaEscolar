  ...
  try {
    ...
    await pool.execute(`
      ...
      VALUES
        ...
        ('promovido_representante',     'Promovido(a) a representante',               'Aviso', 1, 1),
        ('promovido_vice_representante','Promovido(a) a vice-representante',          'Aviso', 1, 1),
        ('removido_vice_representante', 'Removido(a) do cargo de vice-representante', 'Aviso', 0, 0),
        ('removido_grupo',              'Removido(a) de um grupo',                    'Aviso', 0, 0),
        ...
        ('matricula_nova_turma',        'Matriculado(a) em nova turma',            'Aviso',    1, 1),
