# 📋 BAKEOFF — Recomendação de Estudos por IA (Prova Agendada)

**Data:** 2026-08-03
**Status:** Encerrado — todas as decisões foram tomadas. Este documento é só histórico do raciocínio comparativo (opções descartadas, trade-offs). Decisões finais: `docs/SPEC_RECOMENDACAO_ESTUDOS_IA.md`. Plano de execução faseado: `docs/PLANO_IMPLEMENTACAO_RECOMENDACAO_ESTUDOS_IA.md`
**Escopo:** Feature nova, dentro do módulo **Matérias**, associada ao item "prova" (`ProvaAgendada`)
**Nome do arquivo:** renomeado de `PLANO_IMPLEMENTACAO_RECOMENDACAO_ESTUDOS_IA.md` para `BAKEOFF_RECOMENDACAO_ESTUDOS_IA.md` em 2026-08-03, pra liberar o nome canônico `PLANO_IMPLEMENTACAO_*.md` pro plano de execução de verdade (mesmo padrão dos outros módulos, ex. `PLANO_IMPLEMENTACAO_MATERIAS.md`)
...
**Próximo passo:** ✅ concluído — `docs/PLANO_IMPLEMENTACAO_RECOMENDACAO_ESTUDOS_IA.md` já existe, faseado, escrito a partir do spec final.
